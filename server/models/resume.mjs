export const message = "Hello from Server!";
...
export function AllResumes() {
    return resumes.map(({linkedin, summary, skills, education, ...rest}) => rest)
}

export function OneResume(id) {
    return resumes.filter(resume => resume.id === id)[0];
}